...
import torch
from .seg_model import Seg_net,BottleNeck
...
def build_sam_vit_b(num_class,checkpoint=None):
    return _build_sam(
...
def _build_sam(
    ...
    sam = Sam(
        ...
        mask_decoder=MaskDecoder(
            ...
            num_multimask_outputs=num_class,
        ...
        cat_model=Seg_net(block=BottleNeck, layers=[3, 4, 6, 3], num_classes=num_class),
